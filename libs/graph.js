...
const raw_data = {
  nodes: [
    ...
    },
    {
      name: "W.E.B Dubois",
      group: "2",
      image: "./images/mindmap/19.png",
      type: "Theme",
      author: "W.E.B Dubois",
      date: "5/20/2022, 7:25:37 PM",
      text: "One of the most powerful examples of data visualization was made 119 years ago by an all-black team led by W.E.B. Du Bois only 37 years after the end of slavery in the United States.",
    ...
    },
    {
      name: "Art",
      group: "3",
      image: "./images/mindmap/20.jpeg",
      type: "Media",
      author: "None",
      date: "5/20/2022, 7:26:41 PM",
      text: "Any art pieces we have come across",
      x: 549.7099550384668,
    ...
    },
    {
      name: "Tools",
      group: "3",
      image: "./images/mindmap/21.png",
      type: "Media",
      author: "None",
      date: "5/20/2022, 8:03:59 PM",
      text: "Software tools mentioned in class.",
      x: 648.2462001716547,
      y: 628.5466558849291,
      index: 22,
      weight: 6,
    ...
    },
    {
      name: "Privacy Badger ",
      group: "2",
      image: "./images/mindmap/22.jpeg",
      type: "Theme",
      author: "None",
      date: "5/20/2022, 8:04:19 PM",
      text: "Privacy Badger is a browser extension that stops advertisers and other third-party trackers from secretly tracking where you go and what pages you look at.",
      x: 809.2636066066702,
      y: 523.8782795539199,
      index: 23,
      weight: 2,
    ...
    },
    {
      name: "RAWGraphs",
      group: "2",
      image: "./images/mindmap/23.png",
      type: "Theme",
      author: "None",
      date: "5/20/2022, 8:05:02 PM",
      text: "RAWGraphs is a web-based open-source data visualization software made in JavaScript. ",
      x: 490.6431171569551,
      y: 595.8978309631207,
      index: 24,
      weight: 2,
    ...
    },
    {
      ...
      group: "2",
      image: "./images/mindmap/24.jpeg",
      type: "Theme",
      author: "Michel Foucault",
      date: "5/20/2022, 8:06:14 PM",
      text: 'In here, Foucault analyzes the function of Panopticon - "All that is needed, then, is to place a supervisor in a central tower and to shut up in each cell a madman, a patient, a condemned man, a worker or a schoolboy."',
      x: 965.4767655578503,
    ...
    },
    {
      name: "Sousveillance ",
      group: "2",
      image: "./images/mindmap/25.jpeg",
      type: "Theme",
      author: "None",
      date: "5/20/2022, 8:07:02 PM",
      text: "The recording of an activity not from above, but from beneath, usually by members of general public.",
    ...
    },
    {
      ...
      group: "2",
      image: "./images/mindmap/26.jpeg",
      type: "Theme",
      author: "Evgeny Morozov",
      date: "5/20/2022, 8:08:02 PM",
      text: "In this presentation, Morozov argues that we have to use technologies just because we do not have enough resources, or find any better ways to tackle with the bigger problems, which are the real causes and roots.",
      x: 910.6095159631357,
      y: 518.8033572570413,
      index: 27,
      weight: 2,
    ...
    },
    {
      ...
      group: "2",
      image: "./images/mindmap/27.jpeg",
      type: "Theme",
      author: "Nikki Stevens",
      date: "5/20/2022, 8:10:02 PM",
      text: "This reading argues how the data leakage from devices today can be compared to the bleed through the Wound Man, a 15th century surgical diagram ",
      x: 1072.759701063568,
      y: 366.734289252216,
      index: 28,
      weight: 1,
    ...
    },
    {
      name: "Databases",
      group: "3",
      image: "./images/mindmap/28.png",
      type: "Media",
      author: "None",
      date: "5/20/2022, 8:10:46 PM",
      text: "All the databases mentioned throughout the course",
      x: 403.8378907870082,
      y: 236.5682820204062,
      index: 29,
      weight: 2,
    ...
    },
    {
      ...
      group: "2",
      image: "./images/mindmap/29.jpeg",
      type: "Theme",
      author: "None",
      date: "5/20/2022, 8:11:01 PM",
      text: "This is among the largest collections of recorded sound in the world, including music, spoken word and ambient recordings.",
    ...
    },
    {
      name: "Survey123",
      group: "2",
      image: "./images/mindmap/30.jpeg",
      type: "Theme",
      author: "None",
      date: "5/20/2022, 8:12:23 PM",
      text: "ArcGIS Survey123 is a simple and intuitive form-centric data gathering solution. We used it in the class for our final project.",
      x: 659.0220025081128,
      y: 777.4634700030224,
      index: 32,
      weight: 1,
    ...
    },
    {
      ...
      group: "2",
      image: "./images/mindmap/31.jpg",
      type: "Theme",
      author: "Nancy Gleason",
      date: "5/20/2022, 8:14:08 PM",
      text: "Once, Prof. Nancy Gleason also visited our class virtually to talk about tracking ethics in the workplace. This topic has connections to capitalism and privacy.",
      x: 957.9460595522553,
      y: 550.4305709381874,
      index: 33,
      weight: 2,
    ...
    },
    {
      name: "DATA NOT FOUND",
      group: "2",
      image: "./images/mindmap/32.jpeg",
      type: "Theme",
      author: "Kaki King",
      date: "5/20/2022, 8:15:08 PM",
      text: "Data not found is a mesmerizing music performance by guitarist Kaki King, with a lot of projection mapping.",
      x: 613.5736159834958,
      y: -32.65993516526569,
      index: 34,
      weight: 1,
    ...
    },
    {
      ...
      group: "2",
      image: "./images/mindmap/33.jpeg",
      type: "Theme",
      author: "Corning",
      date: "5/20/2022, 8:16:28 PM",
      text: "An advertisement by Corning, a glass company about their concepts for the future. We watched this video together as a class while talking about Internet of Things.",
      x: 669.0424966873253,
      y: 493.4472777179435,
      index: 35,
      weight: 2,
    ...
    },
    {
      ...
      group: "2",
      image: "./images/mindmap/36.webp",
      type: "Theme",
      author: "None",
      date: "5/20/2022, 8:29:58 PM",
      text: "The General Data Protection Regulation (GDPR) is a regulation in EU law on data protection and privacy, and requires the firms to return the data back to users if requested.",
    ...
    },
    {
      name: "Google Takeout",
      group: "2",
      image: "./images/mindmap/37.png",
      type: "Theme",
      author: "None",
      date: "5/20/2022, 8:30:22 PM",
      text: "We also tried Google Takeout and see what data of us Google stores.",
    ...
    },
    {
      ...
      group: "2",
      image: "./images/mindmap/38.jpeg",
      type: "Theme",
      author: "ALEX GONZÁLEZ ORMEROD",
      date: "5/20/2022, 8:32:47 PM",
      text: "This news article discusses how rich people in Mexico are trying to erase their online data. We discussed whether such actions should be permitted, in relation to the right to be forgotten.",
      x: 761.3655215188182,
      y: 292.0956096019174,
      index: 40,
      weight: 3,
